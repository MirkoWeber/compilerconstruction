...
${OBJECTDIR}/lexxer.o: lexxer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lexxer.o lexxer.cpp
...
${OBJECTDIR}/pClasses/ArgumentList.o: pClasses/ArgumentList.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/ArgumentList.o pClasses/ArgumentList.cpp

${OBJECTDIR}/pClasses/ArgumentListDecl.o: pClasses/ArgumentListDecl.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/ArgumentListDecl.o pClasses/ArgumentListDecl.cpp

${OBJECTDIR}/pClasses/ArgumentListDeclS.o: pClasses/ArgumentListDeclS.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/ArgumentListDeclS.o pClasses/ArgumentListDeclS.cpp

${OBJECTDIR}/pClasses/ArgumentListS.o: pClasses/ArgumentListS.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/ArgumentListS.o pClasses/ArgumentListS.cpp

${OBJECTDIR}/pClasses/ArithmeticExpression.o: pClasses/ArithmeticExpression.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/ArithmeticExpression.o pClasses/ArithmeticExpression.cpp

${OBJECTDIR}/pClasses/FunctionBlock.o: pClasses/FunctionBlock.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/FunctionBlock.o pClasses/FunctionBlock.cpp

${OBJECTDIR}/pClasses/FunctionCall.o: pClasses/FunctionCall.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/FunctionCall.o pClasses/FunctionCall.cpp

${OBJECTDIR}/pClasses/FunctionDeclaration.o: pClasses/FunctionDeclaration.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/FunctionDeclaration.o pClasses/FunctionDeclaration.cpp

${OBJECTDIR}/pClasses/FunctionType.o: pClasses/FunctionType.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/FunctionType.o pClasses/FunctionType.cpp
...
${OBJECTDIR}/pClasses/Statement.o: pClasses/Statement.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/Statement.o pClasses/Statement.cpp

${OBJECTDIR}/pClasses/StatementS.o: pClasses/StatementS.cpp
	${MKDIR} -p ${OBJECTDIR}/pClasses
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pClasses/StatementS.o pClasses/StatementS.cpp
